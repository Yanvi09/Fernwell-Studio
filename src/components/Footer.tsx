    ...
    <footer className="bg-brand-green text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12">
          {/* Brand & Info */}
          <div>
            <h3 className="font-fraunces text-3xl font-bold mb-4">Fernwell</h3>
            <p className="text-white/80 mb-4">
              A boutique yoga and pilates studio dedicated to mindful movement and community.
            </p>
            <div className="space-y-2 text-sm text-white/70">
              <p>123 Wellness Street</p>
              <p>San Francisco, CA 94102</p>
              <p className="pt-2">Mon-Fri: 6am-8pm</p>
              <p>Sat-Sun: 8am-6pm</p>
            </div>
          </div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 text-center text-white/60 text-sm">
          <p>&copy; 2024 Fernwell Studio. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
